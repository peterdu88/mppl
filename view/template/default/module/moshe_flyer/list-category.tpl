          ...
          <tbody>
            ...
            <tr class="<?php echo $class; ?>">
              <td align="center"><?php if ($flyer['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $flyer['category_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $flyer['category_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $flyer['title']; ?></td>
              <td class="right"><?php echo $flyer['date_added']; ?></td>
